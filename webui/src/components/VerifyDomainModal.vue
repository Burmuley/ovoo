            ...
            <template v-if="domain?.verification_data">
                ...
                <div class="p-3 rounded mb-3"
                    ...
                    <div class="mb-2 d-flex align-items-start justify-content-between gap-2">
                        <div style="min-width: 0; word-break: break-all;"><span class="text-body-secondary">Host / Name:</span> {{ domain.verification_data.name }}</div>
                        <CButton size="sm" color="success" variant="outline" class="flex-shrink-0" @click="copyName">
                            {{ copiedName ? 'Copied!' : 'Copy' }}
                        </CButton>
                    </div>
                    <div class="d-flex align-items-start justify-content-between gap-2">
                        <div style="min-width: 0; word-break: break-all;"><span class="text-body-secondary">Value:</span> {{ domain.verification_data.value }}</div>
