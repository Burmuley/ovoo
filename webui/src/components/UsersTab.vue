...
<CCard>
    <CCardHeader class="d-flex align-items-center justify-content-between">
        ...
        <CButton v-if="props.userInfo.type === 'admin'" color="primary" size="sm" @click="showAddModal = true">
                ...
                <template v-else>
                    <CTableRow v-for="user in users" :key="user.id">
                        ...
                        <CTableDataCell class="text-end text-nowrap">
                            <CButton v-if="props.userInfo.type === 'admin' || user.id === props.userInfo.id"
                                v-c-tooltip="'Edit'" color="primary" size="sm" variant="outline" class="me-1"
...
<CModal :visible="showAddModal" @close="showAddModal = false" size="lg">
    ...
    <CModalBody>
        <AddUserForm v-if="showAddModal" @created="onUserCreated" @done="showAddModal = false" />
    </CModalBody>
</CModal>
</template>
